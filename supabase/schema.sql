...
-- Product Ingredients (for composite products/recipes)
...
-- Function to calculate available stock for composite products
...
-- Function to decrease stock for composite products (descends into ingredients)
